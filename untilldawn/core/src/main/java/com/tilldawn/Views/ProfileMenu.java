...
public class ProfileMenu implements Screen {
    ...
    private static final float AVATAR_SIZE = 120;
    ...
    public void show() {
        ...
        changeAvatarButton.setColor(new Color(0.2f, 0.8f, 0.6f, 1f));
        ...
        table.row().pad(PADDING, 0, PADDING * 2, 0);
        deleteAccountButton.setColor(new Color(0.9f, 0.2f, 0.2f, 1f));
        deleteAccountButton.addListener(new ClickListener() {
            @Override
            public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
                deleteAccountButton.setColor(new Color(1f, 0.3f, 0.3f, 1f));
        ...
        backButton.addListener(new ClickListener() {
            @Override
            public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
                backButton.setColor(new Color(0.7f, 0.7f, 0.7f, 1f));
